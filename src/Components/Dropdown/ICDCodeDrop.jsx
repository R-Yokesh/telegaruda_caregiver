...
const ICDCodeDrop = ({ options, defaultValue, getSelectedValue, icdKey }) => {
    ...
    const handleOptionClick = (option) => {
        ...
        setSearchTerm(option?.slug || ""); // Set searchTerm to the selected option's name
